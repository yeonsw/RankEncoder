...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        def batcher(params, batch):
            ...
            with torch.no_grad():
                _, last_hidden_state = self.model(**batch, output_hidden_states=True, return_dict=True, sent_emb=True)
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        if self.args.n_gpu > 1:
            model = torch.nn.DataParallel(model, device_ids=[d_id for d_id in range(self.args.n_gpu)])
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                with torch.no_grad():
                    ...
                    baseE_vecs = baseE_vecs[input_ids == self.tokenizer.mask_token_id]
